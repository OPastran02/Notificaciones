...
use Establecimiento\EstablecimientoBundle\Entity\DireccionRS;
use Establecimiento\EstablecimientoBundle\Entity\Historial;

class DireccionRSListener
{
    protected $container;    
    ...
    public function prePersist(LifecycleEventArgs $args)
    {
        ...
        if ($entity instanceof DireccionRS) {
    ...
    public function postPersist(LifecycleEventArgs $args)
    {
        ...
        if ($entity instanceof DireccionProvisoria) {
            ...
            if($eventManager) {
                ...
                if(!is_null($entity->getRazonSocial()->getId()) ){
                    $historial = new Historial();
                    $historial->setIdTabla($entity->getRazonSocial()->getId());
                    $historial->setTabla($className = $entityManager->getClassMetadata(get_class($entity->getRazonSocial()))->getName());
