...
class AsignacionActaListener
{
    ...
    public function prePersist(LifecycleEventArgs $args)
    {
        ...
        if ($entity instanceof AsignacionActa) {
        ...
        if ($entity instanceof AsignacionActa) {
            ...
            if($eventManager) {
                ...
                if(!is_null($entity) ){
                    ...
                    $historial->setCampo("AsignacionActa");
                    $historial->setValorAnterior('CODEDGCONTANUEVO01');
                    $historial->setValorNuevo($entity->getInspector()->getNombre().' '.$entity->getInspector()->getApellido());
