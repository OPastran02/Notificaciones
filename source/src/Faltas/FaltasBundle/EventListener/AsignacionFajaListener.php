...
class AsignacionFajaListener
{
    ...
    public function prePersist(LifecycleEventArgs $args)
    {
        ...
        if ($entity instanceof AsignacionFaja) {
        ...
        if ($entity instanceof AsignacionFaja) {
            ...
            if($eventManager) {
                ...
                if(!is_null($entity) ){
                    ...
                    $historial->setCampo("AsignacionFaja");
                    $historial->setValorAnterior('CODEDGCONTANUEVO01');
                    $historial->setValorNuevo($entity->getIdUsuarioInspector()->getNombre().' '.$entity->getIdUsuarioInspector()->getApellido());
