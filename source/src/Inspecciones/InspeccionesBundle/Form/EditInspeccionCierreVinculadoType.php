...
use Inspecciones\InspeccionesBundle\Form\InspeccionEstablecimientoFinalizarType;
...
class EditInspeccionCierreVinculadoType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('establecimiento',InspeccionEstablecimientoCierreType::class)
    ...
    {
        return 'inspecciones_inspeccionesbundle_edit_inspeccion_cierre_vinculado';
    }
