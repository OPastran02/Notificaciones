var TablaControlInspecciones = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "aoColumnDefs": [
                        ...
                        {"sName": "text", "aTargets": [ 7 ], 'bSortable' : true, "bSearchable": true},
                        {"sName": "text", "aTargets": [ 8 ], 'bSortable' : true, "bSearchable": true},
                        {"sName": "text", "aTargets": [ 9 ], 'bSortable' : true, "bSearchable": true},                        
                        {"sName": "text", "aTargets": [ 10 ], 'bSortable' : true, "bSearchable": true},
                        {"sName": "text", "aTargets": [ 11 ], 'bSortable' : true, "bSearchable": true},
                        {"sName": "text", "aTargets": [ 12 ], 'bSortable' : true, "bSearchable": true},
                        {"sName": "text", "aTargets": [ 13 ], 'bSortable' : true, "bSearchable": true},
                        {"sName": "text", "aTargets": [ 14 ], 'bSortable' : true, "bSearchable": true},
                ]
            }
        });
